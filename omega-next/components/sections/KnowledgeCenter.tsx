...
const guides = [
  { fr: "Guide de la retraite à l'étranger", ar: "دليل التقاعد بالخارج", file: "retraite-etranger/retraite-tunisie-etranger.pdf", preview: "previews/retraite-etranger.jpg" },
