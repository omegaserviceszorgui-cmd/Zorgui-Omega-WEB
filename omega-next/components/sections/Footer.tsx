      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="lg:col-span-2">
            <div className="mb-4">
              <Image src="/images/logo.png" alt="OMEGA SERVICES" width={140} height={56} className="h-14 w-auto object-contain" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {links.map(l => (
                <li key={l.key}>
                  <button onClick={() => scrollTo(l.id)} className="text-white/60 hover:text-[#e8801a] text-sm transition-colors">
                    {t(l.key)}
                  </button>
                </li>
              ))}
