        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center mb-16">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl max-w-sm mx-auto lg:mx-0">
              <img src="/images/founder.png" alt="Mohamed Salah Zorgui"
          ...
          >
            ...
            <p className="text-[#e8801a] font-semibold mb-4 text-base">
              {language === "fr" ? "Plus de 30 ans d'expérience" : "أكثر من 30 عامًا من الخبرة"}
            </p>
            ...
            <button
              ...
              className="bg-[#e8801a] hover:bg-[#d0720f] text-white font-semibold px-7 py-3 rounded-xl transition-all hover:scale-105 active:scale-95 shadow-lg">
              {t("nav.contact")}
            </button>
          </motion.div>
        </div>
