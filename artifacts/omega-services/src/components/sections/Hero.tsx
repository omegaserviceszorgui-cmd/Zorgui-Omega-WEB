...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-br from-[#1a3c6e]/80 via-[#1a3c6e]/60 to-[#0d2140]/75" />
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#e8801a] hover:bg-[#d0720f] text-white font-semibold px-7 py-3.5 rounded-xl shadow-lg shadow-[#e8801a]/30 transition-all hover:scale-105 active:scale-95"
            >
              {t("hero.book")}
            </button>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1fbd5a] text-white font-semibold px-7 py-3.5 rounded-xl shadow-lg shadow-green-500/20 transition-all hover:scale-105 active:scale-95"
            >
