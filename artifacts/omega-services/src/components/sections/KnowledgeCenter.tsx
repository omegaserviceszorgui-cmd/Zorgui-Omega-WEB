...
const guides = [
  ...
  { fr: "Guide Sécurité Sociale", ar: "دليل الضمان الاجتماعي", file: "guide-securite-sociale.pdf" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 text-lg">
            {language === "fr"
              ? "Ressources pratiques pour vous guider dans vos démarches"
              : "موارد عملية لإرشادك في إجراءاتك الإدارية"}
          </p>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {guides.map((guide, i) => (
              ...
              >
                <div className="w-12 h-14 bg-red-50 rounded-lg flex items-center justify-center mb-4 group-hover:bg-red-100 transition-colors">
            ...
            {infographics.map((info, i) => (
              ...
              >
                <div className="h-36 bg-gradient-to-br from-[#1a3c6e]/10 to-[#e8801a]/10 flex items-center justify-center">
                  <Image className="w-14 h-14 text-[#1a3c6e]/30" />
                </div>
                <div className="p-4">
