...
const serviceOptions = {
  fr: [
    "Services administratifs variés",
    "Services de sécurité sociale",
    "Dossiers de retraite à l'étranger",
    "Services VISA",
    "Services étudiants",
    "Ressources Humaines",
  ],
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                <option value="">
                  {language === "fr" ? "Choisir un service..." : "اختر خدمة..."}
                </option>
                {serviceOptions[language].map((s, i) => (
            ...
            <button
              ...
              className="w-full bg-[#1a3c6e] hover:bg-[#0d2140] disabled:bg-gray-300 text-white font-semibold py-3.5 rounded-xl transition-all hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-[#1a3c6e]/20 text-sm"
            >
              {mutation.isPending ? t("form.loading") : t("booking.submit")}
            </button>
